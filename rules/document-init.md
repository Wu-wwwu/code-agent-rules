...
本文件位于 `/rules/document-init.md`，用于规定项目文档如何创建。规则文件统一存放在 `/rules/`；项目专属文档统一存放在 `/documents/`。文档按需加载，不全文通读，Agent 应根据当前任务画像和下一动作精准加载相关章节。
...
- 接到任务后，根据 `/rules/agent.md`「多维任务模型与执行深度」确定最低执行深度，按需加载相关文档章节。
